...
- [pending] **Polish #8.9+** — `chore(trail): Polish #8.9+ — Polish #7.x 🟡-LOW review poly` (Polish #7.5 URL-globbing/console.warn + Polish #7.5b/6/7 → exact breakdown deferred to Polish #9.x re-review).
